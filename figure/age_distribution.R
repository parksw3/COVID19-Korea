...
covid1 <- read_xlsx("../COVID19-Korea-2020-03-10.xlsx", na="NA")
covid2 <- read_xlsx("../COVID19-Korea-2020-03-10.xlsx", na="NA", sheet=2)
covid3 <- read_xlsx("../COVID19-Korea-2020-03-10.xlsx", na="NA", sheet=3)
covid5 <- read_xlsx("../COVID19-Korea-2020-03-10.xlsx", na="NA", sheet=5) ## age
covid9 <- read_xlsx("../COVID19-Korea-2020-03-10.xlsx", na="NA", sheet=9)
...
g1 <- ggplot(age_gather) +
  ...
  geom_point(aes(date_report, value, group=key, col=key,
                shape=key)) +
  scale_x_datetime("Date reported", limits=as.POSIXct(c("2020-02-22", "2020-03-12"))+15*3600, expand=c(0, 0)) +
